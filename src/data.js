...
// Tactical
	eLight: 		{ isTac: 1, level:  0, rarity: 1.00, op: 'max', stat: 'light', value: 6, xDuration: 5.0, isPlayerOnly: 1, name: 'luminari', icon: 'gui/icons/eLight.png' },
	eDark: 			{ isTac: 1, level:  0, rarity: 1.00, op: 'add', stat: 'dark', value: 12, xDuration: 5.0, isPlayerOnly: 1, name: 'darkness', icon: 'gui/icons/eLight.png' },
	eDarkVision: 	{ isTac: 1, level:  0, rarity: 1.00, op: 'max', stat: 'senseDarkVision', value: 6, xDuration: 5.0, isPlayerOnly: 1, name: 'dark vision', icon: 'gui/icons/eLight.png' },
	eSenseTreasure: { isTac: 1, level:  0, rarity: 0.50, op: 'set', stat: 'senseTreasure', value: true, xDuration: 5.0, isPlayerOnly: 1, name: 'sense treasure', icon: 'gui/icons/eVision.png' },
	eSenseLiving: 	{ isTac: 1, level:  0, rarity: 0.50, op: 'set', stat: 'senseLiving', value: true, xDuration: 5.0, isPlayerOnly: 1, name: 'sense life', icon: 'gui/icons/eVision.png' },
	...
	eSenseXray: 	{ isTac: 1, level:  0, rarity: 0.20, op: 'set', stat: 'senseXray', value: true, xDuration: 5.0, isPlayerOnly: 1, name: 'xray vision', icon: 'gui/icons/eVision.png' },
	eSenseSmell: 	{ isTac: 1, level:  0, rarity: 1.00, op: 'set', stat: 'senseSmell', value: 100, isHelp: true, name: 'bloodhound', icon: 'gui/icons/eFragrance.png' },
	eTeleport: 		{ isTac: 1, level:  0, rarity: 1.00, op: 'teleport', range2: 0, random: true, duration: 0, xRecharge: 2.0, isHelp: true, name: 'teleport', icon: 'gui/icons/eTeleport.png' },
	eBlink: 		{ isTac: 1, level:  0, rarity: 1.00, op: 'teleport', targetMe: true, range2: 5, random: false, duration: 0, xRecharge: 2.0, isHelp: true, name: 'blink', icon: 'gui/icons/eTeleport.png' },
...
// All debuffs are reduced duration or effectiveness based on (critterLevel-potionLevel)*ratio
	...
	eSlow: 			{ isDeb: 1, level:  0, rarity: 0.20, op: 'sub', isHarm: 1, stat: 'speed', value: 0.5, xDuration: 0.3, requires: e=>e.speed>0.5, icon: 'gui/icons/eSlow.png' },
...
// Damage
	eBash: 			{ isDmg: 1, level:  0, rarity: 0.00, op: 'damage', xDamage: 1.00, isHarm: 1, duration: 0, damageType: DamageType.BASH, doesItems: true, icon: 'gui/icons/damageBash.png' },
