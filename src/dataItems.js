...
const ShieldMaterials = Fab.add( '', {
	"woodSM": 	{ level:  0, block: '', name: "wood" },
	"silverSM":	{ level:  5, block: 'divine', name: "silver" },
	"iron": 	{ level: 10, block: 'reach', name: 'iron' },
	"beryl": 	{ level: 15, block: 'elemental', name: 'beryl' },
	"pearl": 	{ level: 20, block: 'elemental,reach', name: 'pearl' },
	"opal": 	{ level: 30, block: 'elemental,divine', name: 'opal' },
	"solarium2": { level: 40, block: 'elemental,reach,divine', name: 'solarium' },
});

const ArmorList = Fab.add( '', {
	"fur": 			{ level:  0, rarity: 1.0, xArmor: 0.50, ingredientId: 'leather', img: 'item/armour/animal_skin1.png' },
	"hide": 		{ level:  1, rarity: 1.0, xArmor: 0.80, ingredientId: 'leather', img: 'item/armour/animal_skin2.png' },
	"leather": 		{ level:  2, rarity: 1.0, xArmor: 0.85, ingredientId: 'leather', img: 'item/armour/leather_armour1.png' },
	"studded": 		{ level:  3, rarity: 1.0, xArmor: 0.90, ingredientId: 'iron ingot', img: 'item/armour/banded_mail2.png' },
